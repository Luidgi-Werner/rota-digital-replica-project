...
export const products: Product[] = [
  ...
  },
  {
    ...
    specifications: {
      ...
      'Destaque Histeroscopia': 'Inclinação motorizada do assento em até 25°, que proporciona o posicionamento ideal para a realização de exames de histeroscopia com muito mais conforto e eficiência',
      'Automação Completa': 'Elevação, inclinação do encosto e movimentação da perneira com acionamento elétrico',
  ...
  },
  {
    ...
    price: 34000,
    images: [
      '/lovable-uploads/eaaa50d2-2a93-4489-a672-b987d3d61bc1.png'
    ],
