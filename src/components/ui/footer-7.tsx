...
const defaultSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: "Vendas", href: "/contato" },
      { name: "WhatsApp", href: "https://wa.me/5516994472195" },
      { name: "E-mail", href: "mailto:vendas@lanzamedical.com.br" },
    ],
  },
];
...
export const Footer7 = ({
  ...
  return (
    <section className="py-16 bg-[#003250] text-white">
